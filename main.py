...
firebase_admin.initialize_app(options={'databaseURL': 'https://smartparkingsystem-58ec8-default-rtdb.firebaseio.com/'})
...
def dashboard():
    ...
    if 'loggedin' in session:
        if(session['parking_space']=='A'):
            ...
            with open('SmartParkingSystem-master\slot2.json') as f:
                data = json.load(f)
           # url = "https://thingspeak.com/channels/1208301/field/1.json"
        elif(session['parking_space']=='C'):
            with open('SmartParkingSystem-master\slot3.json') as f:
                data = json.load(f)
           # url = "https://thingspeak.com/channels/1208302/field/1.json"
        else:
            with open('SmartParkingSystem-master\slot4.json') as f:
                data = json.load(f)
